...
This repository contains the Columbia University Modelling Team contribution to the
[COVID-19 Scenario Modeling Hub Research repository](https://github.com/midas-network/covid19-smh-research/),
specifically its **Heterogeneities Round**. The research round was designed to expand
multi-model capacity for representing differences in COVID-19 transmission and severity
among racial/ethnic populations and to estimate how much disease burden might have been
averted if those heterogeneities had been reduced.

The round focused on California and North Carolina and comprised two phases:

- **Phase 1 — prediction:** calibrate to race/ethnicity-specific case and death data through
  November 14, 2020, then project weekly infections and deaths from November 15, 2020,
  through April 3, 2021 under observed heterogeneities.
- **Phase 2 — retrospective counterfactual analysis:** calibrate through April 3, 2021, and
  compare observed heterogeneities (Scenario A) with reduced non-household transmission
